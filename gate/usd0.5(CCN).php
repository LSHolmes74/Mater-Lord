...
//================= [ CURL REQUESTS ] =================//
    ...
    {  
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);  
        curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');  
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount=50&currency=usd&payment_method_types[]=card&description=Fucked By Master Lord&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: €'.$amt.'CCN Charged ✅ <br> ➤ Receipt : NOP';
}
...
elseif(strpos($result1, "generic_decline")) {
    echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br class="color">Result: GENERIC DECLINED</span><br>';
    }
elseif(strpos($result2, "generic_decline" )) {
    echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br class="color">Result: GENERIC DECLINED</span><br>';
}
elseif(strpos($result2, "insufficient_funds" )) {
    echo 'CVV</span>  </span>CC:  '.$lista.'</span>  <br class="color">Result: INSUFFICIENT FUNDS</span><br>';
}

elseif(strpos($result2, "fraudulent" )) {
    echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br class="color">Result: FRAUDULENT</span><br>';
}
...
elseif(strpos($result2, "transaction_not_allowed" )) {
    echo 'CVV</span>  </span>CC:  '.$lista.'</span>  <br class="color">Result: TRANSACTION NOT ALLOWED</span><br>';
    }
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo 'DEAD</span> CC:  '.$lista.'</span>  <br class="color">Result: INCREASE AMOUNT OR TRY ANOTHER CARD</span><br>';
